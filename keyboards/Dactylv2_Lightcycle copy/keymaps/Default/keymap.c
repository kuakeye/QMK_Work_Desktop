 ...
 */
 ...
 //GUIT is window+tab.  only works on win 10
		[_QWERTY] = KC_KEYMAP(
	//,----+----+----+----+----+----.										,----+----+----+----+----+----.
		TAB , Q  , W  , E  , R  , T  ,     									 6  , 7  , 8  , 9 , 0  ,MINS,
	//,----+----+----+----+----+----.										,----+----+----+----+----+----.
		BSPC , A  , S  , D  , F  , G  ,    									  Y  , U  , I  , O , P  ,BSLS,
	//|----+----+----+----+----+----|   									|----+----+----+----+----+----|
		LSFT , Z  , X  , C  , V  , B  ,										H  , J  , K  , L  ,SCLN,QUOT,
	//|----+----+----+----+----+----|										|----+----+----+----+----+----|
		LCTRL,UNDO,LALT,LGUI,A,,											N  , M  ,COMM,DOT,SLSH,RSFT,
	//|----+----+----+----+----+----|										|----+----+----+----+----+----|
	...
	//|----+----+----+----+----+----| 									   |----+----+----+----+----+----|
		ENT , A  , R  , S  , T  , D  ,									      H  , N  , E  , I  , O  ,ENT,
	//|----+----+----+----+----+----|									    |----+----+----+----+----+----|
		LSFT, Z  , X  , C  , V  , B  ,  									  K  , M  ,COMM,DOT ,SLSH,GRV,
	//|----+----+----+----+----+----| 									   |----+----+----+----+----+----|
		LDWN,GRV,PSCR,LEFT,RIGHT,,												,UP ,DOWN,LBRC,RBRC,LUP,
	//`----+----+----+----+----+----'   									 `----+----+----+----+----+----'
	//							`----+----+----+'			`----+----+----'
										ESCT,LALT,			 LGUI, RCTRL,
	//							`----+----+----+'			`----+----+----'
	...
	//|----+----+----+----+----+----|    								|----+----+----+----+----+----|
		ENT , A  , O  , E  , U  , I  ,  								    D  , H  , T  , N  , S  ,SLSH,
	//|----+----+----+----+----+----| 								   |----+----+----+----+----+----|
		LSFT,SCLN, Q  , J  , K  , X  ,  							    B  , M  , W  , V  , Z  , GRV ,
	//|----+----+----+----+----+----|    							   |----+----+----+----+----+----|
		LDWN,GRV,PSCR,LEFT,RIGHT,,												,UP ,DOWN,LBRC,RBRC,LUP,
	//`----+----+----+----+----+----'   									 `----+----+----+----+----+----'
	//							`----+----+----+'			`----+----+----'
...
/*
	...
	//|----+----+----+----+----+----|   							 |----+----+----+----+----+----|
		   ,0CA ,     ,   ,    ,    ,     									,    , UP ,IPCF,     ,   ,
	//|----+----+----+----+----+----|   							 |----+----+----+----+----+----|
		 REST ,    ,XLgn,     ,    ,    ,								,LEFT,DOWN,RIGHT,    ,  REST ,
	//|----+----+----+----+----+----|   							 |----+----+----+----+----+----|
		,    ,    ,    ,    ,   ,    								     ,    ,    ,    ,    ,,
	//|----+----+----+----+----+----|  								  |----+----+----+----+----+----|
	//							`----+----+----+'			`----+----+----'
	...
	//|----+----+----+----+----+----|									|----+----+----+----+----+----|
		REST , 1  ,1, 1  , 1  , 1  ,									NO , 0  , 0  , DOT , NO, REST,
	//|----+----+----+----+----+----|									|----+----+----+----+----+----|
		, 1  , 1  , 1  , 1  ,   ,										NO ,PSLS, PAST, NO , NO  ,,
	//|----+----+----+----+----+----|  									  |----+----+----+----+----+----|
	//							`----+----+----+'			`----+----+----'
										PGUP,PGDN,			 HOME, END,
	//							`----+----+----+'			`----+----+----'
...
*/
	...
	_______, _______, _______, COLEMAK, _______, _______, _______, _______, _______, _______, _______, KC_REST, \
